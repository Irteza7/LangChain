...
def scrape_linkedin_profile(linkdin_url):
    ...
    data = {
        ...
        if v not in ([], "", '', 'null', 'None', None)
            and k not in ["people_also_viewed", "certifications", "similarly_named_profiles", "profile_pic_url"]
    }
    ...
    if "experiences" in data:
        for experience in data["experiences"]:
            ...
            keys_to_remove = [key for key, value in experience.items() if value == "None"]
